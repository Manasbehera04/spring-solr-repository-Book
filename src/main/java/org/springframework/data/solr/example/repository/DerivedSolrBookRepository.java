 ...
 */
public interface DerivedSolrBookRepository extends BookRepo, SolrCrudRepository<Book, String> {

	/*Page<Book> findByPopularity(Integer popularity, Pageable page);

	List<Book> findByNameStartingWith(String name);

	Page<Book> findByAvailableTrue(Pageable page);*/

	/*@Query(SearchableProduct.AVAILABLE_FIELD + ":false")
	Page<Book> findByAvailableFalseUsingAnnotatedQuery(Pageable page);*/
